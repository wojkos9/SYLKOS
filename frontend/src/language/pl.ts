export const pl = {
  ...
  generateCodes: 'generuj kody dostępu',
  ...
  projectSubmit: 'usuń',
  deleteCommentSuccess: 'Usunięto komentarz',
  ok: "OK",
  ...
  desc: 'Opis',
  name: 'Nazwa',
  votingTypetitle: "Nowy typ głosowania",
  votingTypenameLabel: 'Nazwa',
  votingTypenameError: 'Nazwa jest wymagana',
  votingTypedescError: 'Opis jest wymagany',
  ...
  votingScreen:{
    confirm: 'Głosuję',
    ended: 'ZAKOŃCZONE GŁOSOWANIE',
    voting: 'GŁOSOWANIE',
    votingNewProjects: 'GŁOSOWANIE - ZGŁASZANIE PROJEKTÓW',
    startDate: 'data rozpoczęcia',
    endDate: 'data zakończenia', 
    projectYouVotedFor: 'Projekt, na który oddałeś głos',
    restOfProjects: 'Pozostałe projekty, biorące udział w głosowaniu',
  ...
  buttonSubmitVote: {
    submitMyVote : 'potwierdzam swój wybór'
  },
  projectInfo: {
