...
from users.api.views import CurrentUserAPIView, CreateCustomUserView, UserGroupsView, UserProjectsView, UserOwnedGroupsView, user_grant_rights
...
urlpatterns = [
    ...
    path("user/owned_groups", UserOwnedGroupsView.as_view(), name="current-user-owned-groups"),
